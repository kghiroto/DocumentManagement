      ...
      <div class="box-footer">
        <div class="center-block">
          <form role="form" action="{{route('password/create-confirm')}}" method="POST">
            ...
            <button type="button" class="btn btn-danger submit" data-action="{{route('password/create-confirm')}}">戻る</button>
            <button type="button" class="btn btn-danger submit" data-action="{{route('password/create-finish')}}">完了画面へ</button>
          </form>
        </div>
      </div>
    </div>
